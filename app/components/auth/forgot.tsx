  ...
  return (
    <div className="min-h-screen bg-pink-50 flex items-center justify-center">
      <div className="bg-white w-full max-w-md p-8 rounded-2xl shadow-md">
        ...
        <p className="text-center text-gray-500 mb-6">We'll send you a link to reset your password</p>
        ...
        <div className="mt-6 text-center">
          <a href="/auth-pages/login" className="text-rose-600 hover:underline text-sm">
            Back to Sign In
          </a>
        </div>
      </div>
