...
// Replace the existing shirts array with:
const shirts = getProductsBySubcategory("men", "shirts")

export default function MenShirtsPage() {
  const [sortBy, setSortBy] = useState("featured")
  const [filteredProducts, setFilteredProducts] = useState(shirts)
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="relative h-[40vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image src="/placeholder.svg?height=600&width=1200" alt="Men's Shirts" fill className="object-cover" />
        </div>
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-4xl md:text-6xl font-playfair font-light mb-4">Shirts</h1>
          <p className="text-xl font-light">Premium shirts for the modern gentleman</p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h2 className="text-2xl font-semibold">Men's Shirts</h2>
