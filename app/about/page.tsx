      ...
      <section className="relative py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            self-expression, a way to tell your story, and a means to feel
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed text-2xl">
                <p>
                  Founded in 2020 with a vision to democratize luxury fashion,
                  All About Jeans began as a small boutique with big dreams. Our
                  founders, passionate about sustainable fashion and timeless
                  design, set out to create a brand that would offer premium
                  quality clothing at accessible prices.
                </p>
                <p>
                  What started as a curated collection of essential pieces has
                  grown into a comprehensive fashion destination, serving
                  customers worldwide with carefully selected designs that blend
                  contemporary trends with classic elegance.
                </p>
                <p>
                  Today, we're proud to be a trusted name in fashion, known for
              ...
              <div className="aspect-square bg-gradient-to-br from-rose-200 to-purple-200 rounded-2xl flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="absolute inset-0">
                    <Image
                      src="/images/WhatsApp Image 2025-08-20 at 10.13.17 PM (1).jpeg"
                      alt="Contact Us"
                      fill
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-5xl font-playfair font-bold mb-4 text-gray-900">
              Our Values
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-3xl font-semibold mb-3">Sustainability</h3>
                <p className="text-gray-600 text-2xl">
                  We're committed to ethical production practices and
                  sustainable materials that respect our planet and future
                  generations.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-3xl font-semibold mb-3">Quality</h3>
                <p className="text-gray-600 text-2xl">
                  Every piece is crafted with meticulous attention to detail,
                  using only the finest materials and time-tested techniques.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 text-2xl">
                  ...
                  customers, partners, and the communities we serve.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-2xl text-gray-600 leading-relaxed mb-8">
              To make luxury fashion accessible, sustainable, and meaningful. We
              strive to create pieces that not only look beautiful but also make
              you feel confident, comfortable, and connected to something
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-2xl text-gray-600 mb-8">
              ...
              timeless style. Discover your next favorite piece today.
            </p>
